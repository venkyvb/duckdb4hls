# duckdb4hls
This is a sample repository that explores the usage of DuckDB for Health & Lifescience use-cases. **Note that this is an evolving work-in-progress repository. Contributions/feedback is welcome !**
